...
const CAREGIVER_PROGRAMS = [
  ...
  {
    id: 103,
    title: 'Passive Hip & Knee Flexion',
  ...
  {
    id: 104,
    title: 'Passive Ankle Dorsiflexion',
...
export const CaregiverPrograms = () => {
  ...
  const processedPrograms = CAREGIVER_PROGRAMS.map((p) => {
